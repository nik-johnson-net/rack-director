...
function PlatformEdit() {
  ...
  return (
    <div>
      ...
      {/* Warning */}
      <div className="mb-4 px-3 py-2 border-l-[3px] border-warn-border bg-warn-bg text-xs text-text-secondary" style={{ maxWidth: 700 }}>
        Editing platforms after devices have been assigned may cause configuration inconsistencies.
        Only edit if you understand the impact on assigned devices.
      </div>

...
# /agent-image/etc/yum.repos.d (the stock almalinux.repo), where our pinned repo
# IDs are undefined.
dnf --noplugins -y --setopt=reposdir=/etc/yum.repos.d --installroot /agent-image --repo almalinux10-x86_64-baseos-rpms --repo almalinux10-x86_64-appstream-rpms upgrade
